...
│   ├── 武器故事.json                  # 武器故事原文（221条）
│   ├── 材料描述.json                  # 材料描述原文（741条）
│   ├── 敌人图鉴.json                  # 敌人图鉴原文（308条）
│   ├── 书籍全文.json                  # 书籍全文（61卷）
│   ├── 圣遗物故事.json                # 圣遗物故事原文（60套）
│   ├── 角色档案.json                  # 角色档案（88名角色）
│   ├── 魔神任务对话.json              # 魔神任务全对话（含原文）
│   ├── extract_fulltext.py            # 原文提取脚本
│   └── README.md                      # 全量数据说明
